...
<?php foreach ($disth as $d => $v): ?>
	<?php $especialidad = $es->get($v->disp_espid) ?>
	<?php $dhpro += (float)$dhp->getByConsCont($v->disp_id) ?>
	<?php $vacaciones = $v->disp_vacaciones ?>
	<?php $permisos = $v->disp_permisos ?>
	<?php $congreso = $v->disp_congreso ?>
<?php endforeach ?>
...
endforeach;
?>
<?php //echo 'p:' . $pers . ' - e:' . $est . ' - sp:' . $espec ?>
			...
			<div class="nav-tabs-custom nav-tabs-calendar">
				...
				<div class="tab-content tab-calendar">
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="form-group col-xs-5">
												...
												<input type="hidden" id="iNespec" value="<?php echo $especialidad->esp_id ?>">
									...
									<div class="box-body">
										<div class="row">
											<div class="form-group col-xs-6 has-feedback<?php if ($agendado >= $dhpro): ?> has-success<?php endif ?>" id="cuposprog-group">
												...
												<input type="text" class="form-control input-lg input-number" id="cuposprog-id" value="<?php echo number_format($dhpro, 2, '.', '') ?>" readonly>
					...
					<div class="tab-pane fade" id="tab_bh">
							...
							<div class="box-body">
								...
								<div class="row">
									<div class="form-group col-xs-4">
										...
										<p class="form-control-static"><?php echo $vacaciones ?></p>
									</div>

									<div class="form-group col-xs-4">
										<label class="control-label">Días de Permiso</label>
										<p class="form-control-static"><?php echo $permisos ?></p>
									</div>

									<div class="form-group col-xs-4">
										<label class="control-label">Días de Congreso</label>
										<p class="form-control-static"><?php echo $congreso ?></p>
									</div>
								</div>
							</div>
						...
						<?php $totalVacaciones = $vacaciones - $days->dias_vacaciones ?>
						<?php $totalPermiso = $permisos - $days->dias_permiso ?>
						<?php $totalCongreso = $congreso - $days->dias_congreso ?>
