<section class="content-header">
	<h1>Contactabilidad
		<small><i class="fa fa-angle-right"></i> Mensajes enviados</small>
	</h1>
...
<section class="content container-fluid">
	...
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title" id="table-title-f">Mensajes enviados</h3>
		</div>
...
<script src="contactability/manage-sent.js"></script>